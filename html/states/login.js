var Login = function() {};
Login.buttonFontStyle = {font: '15pt opensans', boundsAlignH: 'center',boundsAlignV:'middle', fill: '#000000',fontWeight:'bold'};
...
Login.prototype = {
    ...
    createButton: function(x,y,text,callback) {
        ...
        var buttonText = game.add.text(x,y,text,Login.buttonFontStyle);
